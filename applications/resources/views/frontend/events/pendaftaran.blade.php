        ...
        @endif
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane container active" id="drivertab">
                <hr style="background-color:#CC9E61;color:white">
                <h3><b>DRIVER</b></h3>
                <hr style="background-color:#CC9E61;color:white">
                <div class="row">
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<input name="email1" placeholder="Ketikkan Email..."
                		   class="common-input mb-20 form-control" value="{{ old('email1') }}" type="email" required>
                	...
                	<input name="namaLengkap1" placeholder="Ketikkan Nama Lengkap..."
                		  class="common-input mb-20 form-control" value="{{ old('namaLengkap1') }}" type="text" required>
                	...
                	<input name="nama1" placeholder="Ketikkan Nama Panggilan..."
                		   class="common-input mb-20 form-control" value="{{ old('nama1') }}" type="text" required>
                	 ...
                	 <input name="golonganDarah1" placeholder="Ketikkan Golongan Darah..."
                	  ...
                	  <input name="tempatLahir1" placeholder="Ketikkan Tempat Lahir..."
                			 class="common-input mb-20 form-control" value="{{ old('tempatLahir1') }}" type="text" required>

                	 @if ($errors->has('noTelp1'))
                	   <small style="color:red">* {{$errors->first('noTelp1')}}</small>
                	 @endif
                	 <label><b>No Telepone</b></label>
                	 <input name="noTelp1" placeholder="Ketikkan No Telepone..."
                	  ...
                	  <textarea rows="4" class="common-input mb-20 form-control"
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<select style="height:50px;border-radius: 0" name="ukuranKemeja1" class="common-input mb-20 form-control" required>
                	...
                	<input name="kota1" placeholder="Ketikkan Kota..."
                		 class="common-input mb-20 form-control" value="{{ old('kota1') }}" type="text" required>
                	...
                	<input name="noAnggotaIof1" placeholder="Ketikkan No Anggota IOF..."
                		  class="common-input mb-20 form-control" value="{{ old('noAnggotaIof1') }}" type="text" required>
                	...
                	<input name="rhesus1" placeholder="Ketikkan Rhesus..."
                		   class="common-input mb-20 form-control" value="{{ old('rhesus1') }}" type="text" required>
                   ...
                   <input name="nomorSim1" placeholder="Ketikkan No SIM..."
                		  class="common-input mb-20 form-control" value="{{ old('nomorSim1') }}" type="text" required>
                ...
                <hr style="background-color:#CC9E61;color:white">
                <label class="genric-btn success" onclick="addPengalaman1('tblPengalaman1')">Tambah</label>
                  &nbsp;<label class="genric-btn danger" onclick="delPengalaman1('tblPengalaman1')">Hapus</label>

                <table class="table" id="tblPengalaman1">
                  <tbody>
                	<tr>
                	  <th></th>
                	  <th width="200px">Nama Event's</th>
              ...
              <div class="tab-pane container fade" id="drivercotab">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<input name="email2" placeholder="Ketikkan Email..."
                		   class="common-input mb-20 form-control" value="{{ old('email2') }}" type="email" required>
                	...
                	<input name="namaLengkap2" placeholder="Ketikkan Nama Lengkap..."
                		  class="common-input mb-20 form-control" value="{{ old('namaLengkap2') }}" type="text" required>
                	...
                	<input name="nama2" placeholder="Ketikkan Nama Panggilan..."
                		   class="common-input mb-20 form-control" value="{{ old('nama2') }}" type="text" required>
                	 ...
                	 <input name="golonganDarah2" placeholder="Ketikkan Golongan Darah..."
                	  ...
                	  <input name="tempatLahir2" placeholder="Ketikkan Tempat Lahir..."
                			 class="common-input mb-20 form-control" value="{{ old('tempatLahir2') }}" type="text" required>

                	 @if ($errors->has('noTelp2'))
                	   <small style="color:red">* {{$errors->first('noTelp2')}}</small>
                	 @endif
                	 <label><b>No Telepone</b></label>
                	 <input name="noTelp2" placeholder="Ketikkan No Telepone..."
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	@endif
                	<label><b>Ukuran Baju</b></label>
                	<select style="height:50px;border-radius: 0" name="ukuranKemeja2" class="common-input mb-20 form-control" required>
                		<option value="" >-- Pilih --</option>
                		<option value="XS">XS</option>
                		<option value="S">S</option>
                		<option value="M">M</option>
                	...
                	<input name="kota2" placeholder="Ketikkan Kota..."
                		 class="common-input mb-20 form-control" value="{{ old('kota2') }}" type="text" required>
                	...
                	<input name="noAnggotaIof2" placeholder="Ketikkan No Anggota IOF..."
                		  class="common-input mb-20 form-control" value="{{ old('noAnggotaIof2') }}" type="text" required>
                	...
                	<input name="rhesus2" placeholder="Ketikkan Rhesus..."
                		   class="common-input mb-20 form-control" value="{{ old('rhesus2') }}" type="text" required>
                   ...
                   <input name="nomorSim2" placeholder="Ketikkan No SIM..."
                		  class="common-input mb-20 form-control" value="{{ old('nomorSim2') }}" type="text" required>
                  {{-- END Data Input Driver Kolom 2 --}}
                  </div>
                </div>
                <hr style="background-color:#CC9E61;color:white">
                <h3><b>DATA PENGALAMAN EVENT'S</b></h3>
                <hr style="background-color:#CC9E61;color:white">
                <label class="genric-btn success" onclick="addPengalaman2('tblPengalaman2')">Tambah</label>
                  &nbsp;<label class="genric-btn danger" onclick="delPengalaman2('tblPengalaman2')">Hapus</label>
              ...
              <div class="tab-pane container fade" id="mekanik1tab">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<input name="email3" placeholder="Ketikkan Email..."
                		   class="common-input mb-20 form-control" value="{{ old('email3') }}" type="email" required>
                	...
                	<input name="namaLengkap3" placeholder="Ketikkan Nama Lengkap..."
                		  class="common-input mb-20 form-control" value="{{ old('namaLengkap3') }}" type="text" required>
                	...
                	<input name="nama3" placeholder="Ketikkan Nama Panggilan..."
                		   class="common-input mb-20 form-control" value="{{ old('nama3') }}" type="text" required>
                	 ...
                	 <input name="golonganDarah3" placeholder="Ketikkan Golongan Darah..."
                	  ...
                	  <input name="tempatLahir3" placeholder="Ketikkan Tempat Lahir..."
                			 class="common-input mb-20 form-control" value="{{ old('tempatLahir3') }}" type="text" required>

                	 @if ($errors->has('noTelp3'))
                	   <small style="color:red">* {{$errors->first('noTelp3')}}</small>
                	 @endif
                	 <label><b>No Telepone</b></label>
                	 <input name="noTelp3" placeholder="Ketikkan No Telepone..."
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	@endif
                	<label><b>Ukuran Baju</b></label>
                	<select style="height:50px;border-radius: 0" name="ukuranKemeja3" class="common-input mb-20 form-control" required>
                		<option value="" >-- Pilih --</option>
                		<option value="XS">XS</option>
                		<option value="S">S</option>
                		<option value="M">M</option>
                	...
                	<input name="kota3" placeholder="Ketikkan Kota..."
                		 class="common-input mb-20 form-control" value="{{ old('kota3') }}" type="text" required>
                	...
                	<input name="noAnggotaIof3" placeholder="Ketikkan No Anggota IOF..."
                		  class="common-input mb-20 form-control" value="{{ old('noAnggotaIof3') }}" type="text" required>
                	...
                	<input name="rhesus3" placeholder="Ketikkan Rhesus..."
                		   class="common-input mb-20 form-control" value="{{ old('rhesus3') }}" type="text" required>
                   ...
                   <input name="nomorSim3" placeholder="Ketikkan No SIM..."
                		  class="common-input mb-20 form-control" value="{{ old('nomorSim3') }}" type="text" required>
                ...
                <h3><b>DATA PENGALAMAN EVENT'S</b></h3>
                <hr style="background-color:#CC9E61;color:white">
                <label class="genric-btn success" onclick="addPengalaman3('tblPengalaman3')">Tambah</label>
                  &nbsp;<label class="genric-btn danger" onclick="delPengalaman3('tblPengalaman3')">Hapus</label>
              ...
              <div class="tab-pane container fade" id="mekanik2tab">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<input name="email4" placeholder="Ketikkan Email..."
                		   class="common-input mb-20 form-control" value="{{ old('email4') }}" type="email" required>
                	...
                	<input name="namaLengkap4" placeholder="Ketikkan Nama Lengkap..."
                		  class="common-input mb-20 form-control" value="{{ old('namaLengkap4') }}" type="text" required>
                	...
                	<input name="nama4" placeholder="Ketikkan Nama Panggilan..."
                		   class="common-input mb-20 form-control" value="{{ old('nama4') }}" type="text" required>
                	 ...
                	 <input name="golonganDarah4" placeholder="Ketikkan Golongan Darah..."
                	  ...
                	  <input name="tempatLahir4" placeholder="Ketikkan Tempat Lahir..."
                			 class="common-input mb-20 form-control" value="{{ old('tempatLahir4') }}" type="text" required>

                	 @if ($errors->has('noTelp4'))
                	   <small style="color:red">* {{$errors->first('noTelp4')}}</small>
                	 @endif
                	 <label><b>No Telepone</b></label>
                	 <input name="noTelp4" placeholder="Ketikkan No Telepone..."
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	@endif
                	<label><b>Ukuran Baju</b></label>
                	<select style="height:50px;border-radius: 0" name="ukuranKemeja4" class="common-input mb-20 form-control" required>
                		<option value="" >-- Pilih --</option>
                		<option value="XS">XS</option>
                		<option value="S">S</option>
                		<option value="M">M</option>
                	...
                	<input name="kota4" placeholder="Ketikkan Kota..."
                		 class="common-input mb-20 form-control" value="{{ old('kota4') }}" type="text" required>
                	...
                	<input name="noAnggotaIof4" placeholder="Ketikkan No Anggota IOF..."
                		  class="common-input mb-20 form-control" value="{{ old('noAnggotaIof4') }}" type="text" required>
                	...
                	<input name="rhesus4" placeholder="Ketikkan Rhesus..."
                		   class="common-input mb-20 form-control" value="{{ old('rhesus4') }}" type="text" required>
                   ...
                   <input name="nomorSim4" placeholder="Ketikkan No SIM..."
                		  class="common-input mb-20 form-control" value="{{ old('nomorSim4') }}" type="text" required>
                ...
                <h3><b>DATA PENGALAMAN EVENT'S</b></h3>
                <hr style="background-color:#CC9E61;color:white">
                <label class="genric-btn success" onclick="addPengalaman4('tblPengalaman4')">Tambah</label>
                  &nbsp;<label class="genric-btn danger" onclick="delPengalaman4('tblPengalaman4')">Hapus</label>
              ...
              <div class="tab-pane container fade" id="kendaraantab">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 form-group">
                	...
                	<input name="merek" placeholder="Ketikkan Merek..."
                		   class="common-input mb-20 form-control" value="{{ old('merek') }}" type="text" required>
                	...
                	<input name="noPolisi" placeholder="Ketikkan No Polisi..."
                		  class="common-input mb-20 form-control" value="{{ old('noPolisi') }}" type="text" required>
                	...
                	<input name="typeMesin" placeholder="Ketikkan Type Mesin..."
                		   class="common-input mb-20 form-control" value="{{ old('typeMesin') }}" type="text" required>
                	 ...
                	 <input name="cc" placeholder="Ketikkan CC..."
                			class="common-input mb-20 form-control" value="{{ old('cc') }}" type="text" required>
                	  ...
                	  <input name="merekBan" placeholder="Ketikkan Merek Ban..."
                			 class="common-input mb-20 form-control" value="{{ old('merekBan') }}" type="text" required>
                	 ...
                	 <input name="ukuranBan" placeholder="Ketikkan Ukuran Ban..."
                			class="common-input mb-20 form-control" value="{{ old('ukuranBan') }}" type="text" required>
                    ...
                    <input name="rollbar" placeholder="Ketikkan Rollbar..."
                 			class="common-input mb-20 form-control" value="{{ old('rollbar') }}" type="text" required>
                    ...
                    @if ($errors->has('cargoBarrier'))
                  	...
                  	<input name="cargoBarrier" placeholder="Ketikkan Cargo Barrier..."
                  		 class="common-input mb-20 form-control" value="{{ old('cargoBarrier') }}" type="text" required>
                  	...
                  	<input name="sideBar" placeholder="Ketikkan Side Bar..."
                  		  class="common-input mb-20 form-control" value="{{ old('sideBar') }}" type="text" required>
                  	...
                  	<input name="safetyBelt" placeholder="Ketikkan Safety Belt..."
                  		   class="common-input mb-20 form-control" value="{{ old('safetyBelt') }}" type="text" required>
                     ...
                     <input name="type" placeholder="Ketikkan Type..."
                  		  class="common-input mb-20 form-control" value="{{ old('type') }}" type="text" required>
                     ...
                     <input name="tahun" placeholder="Ketikkan Tahun..." maxlength="5"
                  		   class="common-input mb-20 form-control" value="{{ old('tahun') }}" type="text" required>
                     ...
                     <input name="warna" placeholder="Ketikkan Warna..."
                  		  class="common-input mb-20 form-control" value="{{ old('warna') }}" type="text" required>
                  </div>
                  ...
                  <div class="col-lg-6 form-group">
                   ...
                   <input name="Snorkel" placeholder="Ketikkan Snorkel..."
                		  class="common-input mb-20 form-control" value="{{ old('snorkel') }}" type="text" required>
                   ...
                   <input name="engineCutOff" placeholder="Ketikkan Engine Cut Off..."
                 		  class="common-input mb-20 form-control" value="{{ old('engineCutOff') }}" type="text" required>
                  ...
                  <input name="gps" placeholder="Ketikkan GPS..."
               		  class="common-input mb-20 form-control" value="{{ old('gps') }}" type="text" required>
                  ...
                  <input name="winchDepanMerek" placeholder="Ketikkan Winch Depan Merek..."
               		  class="common-input mb-20 form-control" value="{{ old('winchDepanMerek') }}" type="text" required>
                  ...
                  <input name="winchDepanType" placeholder="Ketikkan Winch Depan Type..."
                		  class="common-input mb-20 form-control" value="{{ old('winchDepanType') }}" type="text" required>
                 ...
                 <input name="winchBelakangMerek" placeholder="Ketikkan Winch Belakang Merek..."
              		  class="common-input mb-20 form-control" value="{{ old('winchBelakangMerek') }}" type="text" required>
                 ...
                 <input name="winchBelakangType" placeholder="Ketikkan Winch Belakang Type..."
               		  class="common-input mb-20 form-control" value="{{ old('winchBelakangType') }}" type="text" required>
                ...
                <input name="snatchBlock" placeholder="Ketikkan Snatch Block..."
                   class="common-input mb-20 form-control" value="{{ old('snatchBlock') }}" type="text" required>
                ...
                <input name="shackle" placeholder="Ketikkan Shackle..."
                   class="common-input mb-20 form-control" value="{{ old('shackle') }}" type="text" required>
               ...
               <input name="glove" placeholder="Ketikkan Glove..."
                 class="common-input mb-20 form-control" value="{{ old('glove') }}" type="text" required>
               ...
               <input name="" placeholder="Ketikkan Sling..."
                   class="common-input mb-20 form-control" value="{{ old('sling') }}" type="text" required>
                ...
                <div class="row">
                    <div class="col-lg-5">
                      ...
                      <hr style="background-color:#CC9E61;color:white">
                      <label class="genric-btn success" onclick="addSpecUpKendaraan('tblSpecUpKendaraan')">Tambah</label>
                        &nbsp;<label class="genric-btn danger" onclick="delSpecUpKendaraan('tblSpecUpKendaraan')">Hapus</label>
                    ...
                    <div class="col-lg-7">
                      ...
                      <hr style="background-color:#CC9E61;color:white">
                      <label class="genric-btn success" onclick="addStrap('tblStrap')">Tambah</label>
                        &nbsp;<label class="genric-btn danger" onclick="delStrap('tblStrap')">Hapus</label>
              ...
              <div class="tab-pane container fade" id="contacttab">
                ...
                <hr style="background-color:#CC9E61;color:white">
                <br>
                  <label class="genric-btn info" onclick="addKeluarga('tblKeluarga')">Tambah</label>
                    &nbsp;<label class="genric-btn danger" onclick="delKeluarga('tblKeluarga')">Hapus</label>
                ...
                <table class="table" id="tblKeluarga">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="dataKeluarga[0][noTelpKeluarga]" placeholder="Ketikkan No Telp..."
                                     class="form-control" value="" type="text" required>
                      </td>
     ...
     function delPengalaman4(tableID) {
      ...
      var numG=1;
        function addKeluarga(tableID) {
          ...
          cell6.innerHTML = '<input type="text" name=dataKeluarga['+numG+'][noTelpKeluarga]" class="form-control" value="" placeholder="Ketikkan No Telp...">';
          var cell7 = row.insertCell(6);
          cell7.innerHTML = '<input type="text" name=dataKeluarga['+numG+'][noHpKeluarga]" class="form-control" value="" placeholder="Ketikkan No Hp...">';
        }
